...
#ifdef NDEBUG
#define spar_name_same(vname1, vname2) ((vname1) == (vname2))
#else
#define spar_name_same(vname1, vname2) ((DV_UNAME != DV_TYPE_OF ((vname1)) || DV_UNAME != DV_TYPE_OF ((vname2))) ? (GPF_T, 0) : ((vname1) == (vname2)))
#define sparp_name_same_3(sparp, vname1, vname2) ((DV_UNAME != DV_TYPE_OF ((vname1)) || DV_UNAME != DV_TYPE_OF ((vname2))) ? (spar_internal_error (sparp, "sparp_" "name_same_3(): bad arg"), 0) : ((vname1) == (vname2)))
#endif
